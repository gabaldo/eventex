...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Marcus Gabaldo', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('gabaldo@gmail.com', email.body)
        self.assertIn('41-9137-1113', email.body)
...
class SubscribeSeccessMessage(TestCase):
